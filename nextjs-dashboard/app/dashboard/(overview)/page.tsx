...
export default async function Page() {
  ...
  const {
    ...
    return (
      <main>
                <h1 className={'${lustiana.className} mb-4 text-xl md:text-2xl sticky'}>
        ...
        <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div className="mt-6">
                        <h5 className="text-xl text-blue-700 text-center">Performance score</h5>
...
<div className="min-h-screen bg-gray-100 space-y-12 py-10">
  <div className="container mx-auto">
    <div className="bg-white max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
      <div className="h-20 bg-red-500 flex items-center justify-between">
        ...
        <p className="mr-20 text-white text-lg">Subject1</p>
        <p className="mr-4 text-white font-thin text-lg">Teacher1</p>
      </div>
  ...
  <div className="container mx-auto">
    <div className="bg-white max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
      <div className="h-20 bg-green-500 flex items-center justify-between">
        ...
        <p className="mr-20 text-white text-lg">Subject2</p>
        <p className="mr-4 text-white font-thin text-lg">Teacher2</p>
      </div>
  ...
  <div className="container mx-auto">
    <div className="bg-white max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
      <div className="h-20 bg-purple-500 flex items-center justify-between">
        <h1 className="text-white ml-4 border-2 py-2 px-4 rounded-full">3</h1>
        <p className="mr-20 text-white text-lg">subject3</p>
        <p className="mr-4 text-white font-thin text-lg">Teacher3</p>
      </div>
...
<div className="min-h-screen bg-gray-100 space-y-12 py-9">
  <div className="container mx-auto">
    <div className="bg-white max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
      <div className="h-20 bg-red-500 flex items-center justify-between">
        <h1 className="text-white ml-4 border-2 py-2 px-4 rounded-full">1</h1>
        <p className="mr-20 text-white text-lg">subject4</p>
        <p className="mr-4 text-white font-thin text-lg">Teacher4</p>
      </div>
  ...
  <div className="container mx-auto">
    <div className="bg-white max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
      <div className="h-20 bg-green-500 flex items-center justify-between">
        <h1 className="text-white ml-4 border-2 py-2 px-4 rounded-full">2</h1>
        <p className="mr-20 text-white text-lg">Subject5</p>
        <p className="mr-4 text-white font-thin text-lg">Teacher3</p>
      </div>
  ...
  <div className="container mx-auto">
    <div className="bg-white max-w-sm mx-auto rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
      <div className="h-20 bg-purple-500 flex items-center justify-between">
        <h1 className="text-white ml-4 border-2 py-2 px-4 rounded-full">3</h1>
        <p className="mr-20 text-white text-lg">subject6</p>
        <p className="mr-4 text-white font-thin text-lg">Teacher3</p>
      </div>
